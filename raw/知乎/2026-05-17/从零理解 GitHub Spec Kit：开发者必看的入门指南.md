...
source: "https://zhuanlan.zhihu.com/p/1981659360842249886"
author:
  - "[[技术极简主义简单就是最美好的技术表现形式]]"
published:
created: 2026-05-17
description: "你是否也曾陷入这样的开发困境？ 直接对 AI 助手说「帮我写个XX功能」，然后花大量时间修正它那不尽如人意的代码；团队沟通需求靠零散的聊天记录，项目进展凭感觉走，最终导致返工和混乱。 说实话，这种依赖直觉、…"
tags:
  - "clippings"
---
...
说实话，这种依赖直觉、漫无目的的开发方式，我称之为「 [Vibe Coding](https://zhida.zhihu.com/search?content_id=267386344&content_type=Article&match_order=1&q=Vibe+Coding&zhida_source=entity) 」（感觉式编程）。

**这种看似敏捷的开发方式，本质上是对项目熵增的放任。**

它或许能应对小修小补，但对于严肃的软件工程项目，这无异于一场灾难。

所幸的是，我们不必一直如此。GitHub 近期发布了一套名为 [Spec Kit](https://zhida.zhihu.com/search?content_id=267386344&content_type=Article&match_order=1&q=Spec+Kit&zhida_source=entity) 的工具，它由微软开发，旨在为 AI 驱动的软件开发提供一套清晰、规范的「脚手架」和方法论。
...
![](https://pic3.zhimg.com/v2-e9b0a8021224b6a0c61e817cf5127b4e_1440w.jpg)
...
![](https://pica.zhimg.com/v2-0d87d8676f1dc0767f63133f663e5234_1440w.jpg)

![](https://pic3.zhimg.com/v2-1607f420e18e4f200dbae81f36c8b2e0_1440w.jpg)
...
- 标记任务为完成
```
![](https://picx.zhimg.com/v2-1b568491fbe7630ea88865069ca71321_1440w.jpg)
...
- 创建数据模型
- 创建快速开始指南
![](https://pica.zhimg.com/v2-4e5caafa5f1751041658114d6de61918_1440w.jpg)

4️⃣ 生成任务清单

方案确认后，使用 `/speckit.tasks` 命令。Claude 会自动分析 `plan` 文件，生成一份详细、可执行的任务列表。

![](https://pic1.zhimg.com/v2-ec2b0738a772801e15564d5ac590647a_1440w.jpg)

5️⃣ 开始实现

万事俱备，现在只需执行 `/speckit.implement` 。Claude 就会像一个经验丰富的工程师，按照任务清单逐一完成代码实现。

![](https://picx.zhimg.com/v2-ec9c4e80ad71d8733c65a2bd0edd4117_1440w.jpg)
...
![](https://pic4.zhimg.com/v2-bd89ad6479470fcd4aafb860bb5c78c3_1440w.jpg)

产品运行效果：

![](https://pic2.zhimg.com/v2-901982b7555e9120b33c058b9622fa13_1440w.jpg)
...
编辑于 2025-12-09 09:45・江苏[别再撸电子猫了，下一代“电子龙虾”搭子DuMate才是真搭子](https://dumate.cn/?track=sczhtf&spu=biz%3D0%26ci%3D3711230%26si%3Dfec4e0dc-32f4-4402-b81e-3dedaf67f5eb%26ts%3D1778990416%26zid%3D1629)

[

AI兴趣党的快乐，就是有个能替你熬夜的龙虾级搭子。

](https://dumate.cn/?track=sczhtf&spu=biz%3D0%26ci%3D3711230%26si%3Dfec4e0dc-32f4-4402-b81e-3dedaf67f5eb%26ts%3D1778990416%26zid%3D1629)