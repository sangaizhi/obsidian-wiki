...
source: "https://zhuanlan.zhihu.com/p/2040834441451459515?share_code=1m61oxP5lTkjn&utm_psn=2045519105113977890"
author:
  - "[[代码随想录在腾讯、百度从事一线技术开发，公众号：「代码随想录」]]"
published:
created: 2026-06-05
description: "大模型系统教程，尽在 卡码笔记 之前分享了 录友四面字节Agent开发岗的面经，里面就有一个很不错的面试问题：“为什么你这里要拆多个 Agent？一个 Agent 多挂几个 Tool 不行吗？” 这个问题就是问多Agent架构，看…"
tags:
  - "clippings"
---
![](https://picx.zhimg.com/v2-b18b5cf6208537ab871fe7d6121ca0e5_1440w.jpg)

大模型系统教程，尽在

之前分享了 [录友四面字节Agent开发岗的面经](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/QPd5LD7ktAD_rNqcvHAg6Q) ，里面就有一个很不错的面试问题：
...
[Claude Code大厂面试题汇总](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/ru-g8h5WgBc2bE-v3gVg7w) 里拆解过 Claude Code 的子Agent机制——主Agent通过Agent工具启动Explore、Plan、General-purpose三类子Agent，各自独立执行，结果回传汇总。这就是一个典型的多Agent架构：看起来是调Tool，内部其实是完整的Agent。
...
- 子Agent独立执行
- 结果回传与汇总
1. 编排模式：主Agent协调子Agent的四种方式
- 顺序管道
- [Map-Reduce](https://zhida.zhihu.com/search?content_id=275306263&content_type=Article&match_order=1&q=Map-Reduce&zhida_source=entity)
- 层级嵌套
- 路由分发
1. Tool调用 vs 多Agent架构：本质区别在哪
2. Agent-as-Tool：中间态，不是非黑即白
3. 什么场景用多Agent，什么场景Tool就够了
4. 多Agent的代价：不是免费的午餐
5. 真实框架怎么做多Agent通信
6. 面试怎么答
...
![](https://pic3.zhimg.com/v2-cc6d38f5809670d6ab5c545621c09a5e_1440w.jpg)
...
```
![](https://picx.zhimg.com/v2-67f6ee1ce4faf6335143e5a509e8086d_1440w.jpg)
...
- **结果冲突** ：搜索Agent说定价79，听谁的？
- **格式统一** ：不同子Agent返回格式可能不同，需要归一化
- **质量过滤** ：置信度低的结果要降权或丢弃
- **证据校验** ：没有来源的结论不能直接进入最终答案
![](https://picx.zhimg.com/v2-2263250fd01c95479fc22bda5500e52b_1440w.jpg)

![](https://pic2.zhimg.com/v2-473e0c574b6d6940e375223bc75ef7cd_1440w.jpg)
...
适用于：请求类型多样、每种类型有专门处理逻辑的场景。类似 [Agent混合路由优化](https://link.zhihu.com/?target=https%3A//mp.weixin.qq.com/s/ZyzlPbixau9TYLQwqJKUQg) 里讲的思想：先判断任务类型和复杂度，再选择最合适的执行路径。

![](https://pic3.zhimg.com/v2-c1d9926872b0adcb420362eb16b3e900_1440w.jpg)
...
![](https://pic4.zhimg.com/v2-a1dba5bd535c33571e3bc45e335bfe47_1440w.jpg)
...
![](https://pic1.zhimg.com/v2-f3d1c3d5d4b18cb1035e21917a895424_1440w.jpg)

### 七、多Agent的代价：不是免费的午餐

面试里只讲多Agent的好处不讲代价，面试官会觉得你只做过demo没踩过坑。多Agent架构有几个必须正视的代价：

![](https://pic2.zhimg.com/v2-02717c7b2e2bc2bdae7fa20fe6638107_1440w.jpg)
...
发布于 2026-05-21 16:42・广东[Agent](https://www.zhihu.com/topic/28352669)