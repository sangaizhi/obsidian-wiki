...
source: "https://zhuanlan.zhihu.com/p/2025609367379026526?share_code=5cVAueFgE8pW&utm_psn=2039682873930863355"
author:
  - "[[TraeTRAE，The Real AI Engineer]]"
published:
created: 2026-06-05
description: "本文作者：咸鱼，TRAE 开发者用户前言针对现在层出不穷的 AI 新概念，拒绝「错失恐惧症」，也就是我们常说的 Fomo！ 请先对自己默念：拒绝 Fomo！拒绝 Fomo！拒绝 Fomo！重要的事情说三遍呀！Harness 并不是 AI 圈…"
tags:
  - "clippings"
---
49 人赞同了该文章
...
Harness 并不是 AI 圈子凭空发明的新概念。作者在此前的 AI 实践中，一直在尝试总结一套完整的方法论，但发现无论是 Prompt Engineering 还是 [Context Engineering](https://zhida.zhihu.com/search?content_id=272806944&content_type=Article&match_order=1&q=Context+Engineering&zhida_source=entity) ，都无法很好地囊括全部实践。于是，作为前端工程师，索性自己造了个新词： **“AI 工程化”或“AI 基建设计”。**

**[Harness Engineering](https://zhida.zhihu.com/search?content_id=272806944&content_type=Article&match_order=1&q=Harness+Engineering&zhida_source=entity) 这个词的出现，不过是用一个更形象、更生动的词语，对这类现有实践做了一次系统性的汇总和命名。**

本文的部分内容来源于作者多次模型评测和工程实践中的思考，行文风格可能与常见的技术文章有所不同。如有不当之处，还请大家不吝指正。在正式阅读这篇文章之前，我也给大家准备了一份术语说明，如果你在阅读过程中有任何不清楚的地方，欢迎随时查看。

![](https://picx.zhimg.com/v2-066a5a7c895385c2272fc2dd0838a695_1440w.jpg)

废话不多说，正文开始～

## 一、Harness Engineering 是什么？

![](https://pic2.zhimg.com/v2-87f4fa84d7de22a51caa54b3362246a9_1440w.jpg)
...
> Harness 就是：除了 [LLM](https://zhida.zhihu.com/search?content_id=272806944&content_type=Article&match_order=1&q=LLM&zhida_source=entity) 本身之外，让 Agent 真正能干活的一切 **基础设施** 。Harness Engineering 不是“更好的提示词（Prompt）”，也不是“更强的模型”，而是优化模型运行的环境与机制。它的本质是 **优化模型运行所需的环境、机制与基础设施的总和** ，它是一套将 AI 的“智能”转化为可靠、可控、可规模化“生产力”的工程哲学与实践框架。
...
- **[沙盒执行](https://zhida.zhihu.com/search?content_id=272806944&content_type=Article&match_order=1&q=%E6%B2%99%E7%9B%92%E6%89%A7%E8%A1%8C&zhida_source=entity) ：** 所有不授信的代码或指令必须在严格隔离的沙盒中执行。
...
> [openai.com/zh-Hans-CN/i](https://link.zhihu.com/?target=https%3A//openai.com/zh-Hans-CN/index/harness-engineering/)

![](https://pic1.zhimg.com/v2-70a64cca1dbb2c9dacabba21ec1b4e0a_1440w.jpg)
...
在当前基于 [Transformer](https://zhida.zhihu.com/search?content_id=272806944&content_type=Article&match_order=1&q=Transformer&zhida_source=entity) 和自回归的 LLM 架构下，模型的原始输出本质上是随机且无序的。
...
![](https://pic2.zhimg.com/v2-eaf4afcc2c92095c320ded3ccff0c2e3_1440w.jpg)
...
![](https://pic2.zhimg.com/v2-9b07af38cf0900b0f58a28c0a387689d_1440w.jpg)
...
![](https://pic2.zhimg.com/v2-ed1e36b5214bbe2a5f7240fb7b228639_1440w.jpg)
...
![](https://pic4.zhimg.com/v2-9313e477f9ee1b1998a5eb190c6fad0d_1440w.jpg)
...
![](https://pic1.zhimg.com/v2-e265f8c95e582c49f27856a79a0b0220_1440w.jpg)
...
![](https://pic2.zhimg.com/v2-24fcf32d9c77ab53e91923c1a775c3fb_1440w.jpg)
...
![](https://pic4.zhimg.com/v2-9a69eecbb96f7f7e4c3442503c8e9ee3_1440w.jpg)
...
![](https://pic2.zhimg.com/v2-463170d19923d5d36f2e491c09418fb5_1440w.jpg)
...
![](https://pic3.zhimg.com/v2-3afe4d978c66701b649787e66ba99434_1440w.jpg)
...
**5.4.3 安全与合规： [策略门控](https://zhida.zhihu.com/search?content_id=272806944&content_type=Article&match_order=1&q=%E7%AD%96%E7%95%A5%E9%97%A8%E6%8E%A7&zhida_source=entity)**
...
发布于 2026-04-13 10:45・北京[日本SGU项目37所日本大学参与，相较于传统留学途径有哪些优势？](https://zhuanlan.zhihu.com/p/623149927)
