...
source: "https://zhuanlan.zhihu.com/p/2043394581216092169?share_code=TvTZ48PKEjXD&utm_psn=2047075755289481689"
author:
  - "[[JavaGuide​​开源项目《JavaGuide》 作者]]"
published:
created: 2026-06-07
description: "你好，我是小 G。拖了蛮久，来填坑了。 Spec Coding 很早之前就有群友提到说建议写一下。确实还蛮重要的，工作中能用到，面试也开始问了。 这里以我想的一个真实工作场景的例子作为开场。 上周和同事聊天，他问我…"
tags:
  - "clippings"
---
[收录于 · JavaGuide（后端 & AI面试）](https://www.zhihu.com/column/Snaiclimb)
...
![](https://picx.zhimg.com/v2-84fcef5d44474d3f9e3eaa620ef02c51_1440w.jpg)

这里以我想的一个真实工作场景的例子作为开场。

上周和同事聊天，他问我还在折腾 Spec Coding 干嘛。原话大概是：“ [Claude Code](https://zhida.zhihu.com/search?content_id=275777879&content_type=Article&match_order=1&q=Claude+Code&zhida_source=entity) 都能自己写代码了，你花时间写规范不是多此一举？”
...
1. [Vibe Coding](https://zhida.zhihu.com/search?content_id=275777879&content_type=Article&match_order=1&q=Vibe+Coding&zhida_source=entity) 和 Spec Coding 的实际差别，以及什么时候该用哪个
2. 完整的 Spec Coding 落地流程，从写需求到让 AI 按规矩执行
3. Spec 在主流 AI IDE（ [Cursor](https://zhida.zhihu.com/search?content_id=275777879&content_type=Article&match_order=1&q=Cursor&zhida_source=entity) 、Claude Code、 [Copilot](https://zhida.zhihu.com/search?content_id=275777879&content_type=Article&match_order=1&q=Copilot&zhida_source=entity) 等）里怎么配、怎么管、怎么防止 AI 越界

## Vibe Coding 不是不能用

![](https://pica.zhimg.com/v2-9f900a26d980ced4e6dfe9b7a272af28_1440w.jpg)

Vibe Coding（氛围编程），凭感觉走。给 AI 一句模糊的意图，它就直接开始输出代码。

[Karpathy](https://zhida.zhihu.com/search?content_id=275777879&content_type=Article&match_order=1&q=Karpathy&zhida_source=entity) 最早提这个词时，说的也是那种把需求丢给 AI、顺着感觉不断调整、甚至暂时不太管代码细节的写法。
...
![](https://pic3.zhimg.com/v2-e69f84f0feb2862875004963612c1886_1440w.jpg)
...
![](https://pic3.zhimg.com/v2-d91fa4b2761b2549c14122ce644a0e56_1440w.jpg)

Spec Coding 规范驱动编程流水线
...
![](https://pic4.zhimg.com/v2-c27461de7b9b5745635a821571d41c67_1440w.jpg)
...
![](https://pic3.zhimg.com/v2-809fba42f989e537094b4aed9bc24e06_1440w.jpg)
...
![](https://pic4.zhimg.com/v2-15741122d23850c016c6b51cf012feb9_1440w.jpg)
...
手动选文件不现实了，得上 RAG。Embedding 模型选 text-embedding-3-small/large，向量库看规模：Chroma 适合本地，Pinecone 适合云端， [Milvus](https://zhida.zhihu.com/search?content_id=275777879&content_type=Article&match_order=1&q=Milvus&zhida_source=entity) 适合企业级。Chunk 策略按语义单元切，一个 Task 或一个 API 定义为一个 chunk，默认控制在 512-1024 tokens 之间。Top-K 召回 3-5 条，加相似度阈值 > 0.7。
...
![](https://picx.zhimg.com/v2-f5415dc9f8cbffcf5390fb3eedb6116f_1440w.jpg)
...
你好，我是 [JavaGuide](https://link.zhihu.com/?target=https%3A//javaguide.cn/) 的作者。最近几个月一直在继续补充完善 AI 应用开发部分的内容。

目前的话，这份面向后端开发者的 AI 应用开发、AI 编程实战与面试指南已免费开源，涵盖 LLM、Agent、RAG、MCP、Claude Code、Codex 等核心技术与工程实践。对标 [JavaGuide](https://link.zhihu.com/?target=https%3A//javaguide.cn/home.html) ！有帮助的话，欢迎 Star！

- **项目地址** ： [github.com/Snailclimb/A](https://link.zhihu.com/?target=https%3A//github.com/Snailclimb/AIGuide)
- **在线阅读** ： [AI 应用开发知识体系：大模型、Agent、RAG、MCP、Prompt 工程与系统设计](https://link.zhihu.com/?target=https%3A//javaguide.cn/ai/)

这应该是当前最全面系统的讲解，每一篇都花费了大量时间完善和优化，每篇文章都画了大量配图辅助理解：

![](https://picx.zhimg.com/v2-60537c56c1d1516748353c14f0eb2277_1440w.jpg)

AIGuide 内容概览，大量配图

发布之后，也是收到了很多读者朋友的好评和推荐。非常感谢，一定会持续用心维护！

![](https://pica.zhimg.com/v2-eed6ffb3804694488756620a4ef65a6a_1440w.jpg)

AIGuide 收到了很多读者朋友的好评和推荐

[所属专栏 · 2026-05-31 08:08 更新](https://zhuanlan.zhihu.com/Snaiclimb)

[![](https://picx.zhimg.com/v2-c5be1695771c4f9b442b5bde56e5e8e0_720w.jpg?source=172ae18b)](https://zhuanlan.zhihu.com/Snaiclimb)

[JavaGuide（后端 & AI面试）](https://zhuanlan.zhihu.com/Snaiclimb)
...
](https://zhuanlan.zhihu.com/Snaiclimb)
